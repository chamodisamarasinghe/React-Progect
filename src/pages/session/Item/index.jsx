...
function createData(
    ...
    return { code, item, price, qty};
}

const rows = [
    createData('I-001', 'Rice', '700.00', 10),
    createData('I-002', 'Toothpaste', '70.00', 5),
    createData('I-003', 'Sugar', '600.00', 500),
    createData('I-004', 'Soap', '135.00', 10),
